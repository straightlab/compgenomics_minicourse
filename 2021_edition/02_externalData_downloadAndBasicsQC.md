...
Note: the following command takes a bit of time, so we've already downloaded the file into our directory. Use the cp command to copy from our dir to yours.
fasterq-dump SRR13403380 --progress --threads 2 --temp $GROUP_SCRATCH/biochem_minicourse_2021/$me/tmp/ --outdir ./raw

cp $GROUP_SCRATCH/biochem_minicourse_2021/teamStraight/data/external/raw/SRR13403380.fastq ./raw
```
...
# 5711592 SRR13403380.fastq
# 5711592/4 = 1427898 reads
```
